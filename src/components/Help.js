...
const GROUPS = [
  ...
  ['제어', [['x', 'kill 노드 / call 서비스 / set 파라미터'], ['r', '노드 재시작'],
    ['R', 'rosbag 녹화 토글'], ['P', 'rosbag 재생']]],
  ['도구 · 컨텍스트', [['c', '연결 뷰(pub/sub)'], ['t', 'TF 프레임 트리'], ['S', '노드 리소스(CPU/RSS)'],
    ['b / 1-9', '북마크(명령 단축)'], ['J', '작업(Jobs) 조회·종료'], ['h', 'Hz 측정 모드'], ['D', 'ROS_DOMAIN_ID']]],
  ['기타', [['?', '이 도움말'], ['q', '종료']]],
];
