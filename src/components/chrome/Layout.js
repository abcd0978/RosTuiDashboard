...
const isModal = (d) => !!(d.help || d.preflightOpen || d.watchOpen || d.pubForm || d.jobsOpen
  || d.bmOpen || d.bmAdd || d.infoView || d.plotPick || d.graphOpen || d.qosOpen || d.logOpen || d.paramPanel || d.overviewOpen || d.diagOpen || d.lifeOpen || d.teleopOpen || d.doctorOpen || d.baselineOpen);
